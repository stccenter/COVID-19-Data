...
output_path = './'
yesterday = datetime.date.today() - datetime.timedelta(days=29)
url1 = "https://raw.githubusercontent.com/stevenliuyi/covid19-csv/master/csv/admin1_" + \
    yesterday.strftime("%Y-%m-%d") + ".csv?token=GHSAT0AAAAAABJWNYEWXATLEO3ZV6DOQAT6YPSVCZA"
url2 = "https://raw.githubusercontent.com/stevenliuyi/covid19-csv/master/csv/admin2_" + \
    yesterday.strftime("%Y-%m-%d") + ".csv?token=GHSAT0AAAAAABJWNYEW6JDVVRKBVT3OCKZIYPSVDBA"
